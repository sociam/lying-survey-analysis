...
Pertaining to online deception, a number of studies have compared online to offline lying practices. Hancock et al.~\cite{hancock2004deception} set out to settle the debate between \emph{media richness theory}, which postulates that lying is more likely in richer interaction (with more and immediate feedback) interactions, against \emph{social distance theory}, which frames lying to be more likely in social cue impoverished settings such as via e-mail. Beyond this, Hancock also test other proeprties of interaction, including synchronicity, co-located physical presence, finding, in a controlled experiment, that 
